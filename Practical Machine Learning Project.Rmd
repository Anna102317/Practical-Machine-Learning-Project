...
if (!file.exists(train.file)) {
        download.file(train.url, destfile="/Users/jiaoweiqi/OneDrive - Johns Hopkins University/R/training.csv", method="curl")
}
if (!file.exists(test.file)) {
        download.file(test.url, destfile="/Users/jiaoweiqi/OneDrive - Johns Hopkins University/R/testing.csv", method="curl")
}

train.data.raw <- read.csv("~/OneDrive - Johns Hopkins University/R/training.csv", na.strings=c("NA","#DIV/0!",""))
test.data.raw <- read.csv("~/OneDrive - Johns Hopkins University/R/testing.csv", na.strings=c("NA","#DIV/0!",""))
```
